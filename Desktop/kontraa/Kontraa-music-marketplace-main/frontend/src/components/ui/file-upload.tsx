  ...
  function FileUploadItem(props, ref) {
    ...
    return (
      <ChakraFileUpload.Item
        ...
        border={"none"}
        px={2}
        py={file.type.split("/")[0] === "image" ? 2 : 6}
        color={"white"}
      >
        ...
        {showSize ? (
          <ChakraFileUpload.ItemContent>
            <ChakraFileUpload.ItemName color={"white"} />
            {file.type.split("/")[0] === "image" && (
              <ChakraFileUpload.ItemPreviewImage width={"200px"} />
            )}
...
>(function FileUploadList(props, ref) {
  ...
  return (
    <ChakraFileUpload.ItemGroup ref={ref} {...rest} rounded={"md"}>
